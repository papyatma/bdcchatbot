class SeancesController < ApplicationController
  ...
  private
    ...
    def seance_params
      params.require(:seance).permit(:public, :ageMin, :ageMax, :niveau, :sexe, :periode, :jour, :heureDebut, :heureFin, :dateDebut, :dateFin, :tarif, :place_id, :activite_id, :structure_id)
    end
end
