...
class StructuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create structure" do
    assert_difference('Structure.count') do
      post structures_url, params: { structure: { address: @structure.address, email: @structure.email, name: @structure.name, phone: @structure.phone, type: @structure.type, zipcode: @structure.zipcode } }
    end
  ...
  test "should update structure" do
    patch structure_url(@structure), params: { structure: { address: @structure.address, email: @structure.email, name: @structure.name, phone: @structure.phone, type: @structure.type, zipcode: @structure.zipcode } }
