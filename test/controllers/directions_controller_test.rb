...
class DirectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create direction" do
    assert_difference('Direction.count') do
      post directions_url, params: { direction: { name: @direction.name, typeOffer: @direction.typeOffer } }
    end
  ...
  test "should update direction" do
    patch direction_url(@direction), params: { direction: { name: @direction.name, typeOffer: @direction.typeOffer } }
